use pirtm_engine::sigma_layer::{certify_state, ZeroModeExtractable};
use pirtm_engine::state::{PrimeChannel, RuntimeState, SkeletonState, TensorMapState};
...
fn main() {
    ...
    let zm_metrics = current_state
        .extract_zm_quantities()
        .expect("Failed to extract ZM quantities");
